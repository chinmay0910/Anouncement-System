...
import BrandLogo from '/megaphone.svg'
    ...
    return (
        ...
        <div className="h-screen w-full z-40">
            ...
            <div className="flex flex-row">
                ...
                <h1 className="font-bold text-2xl p-4">Anouncement System</h1>
            </div>
            <div className="flex flex-row h-[90%]">
                ...
                <div className="w-1/2 flex flex-col h-[100%]">
                    <div className="flex flex-row py-12 pb-8">
                        ...
                        <h1 className="text-xl font-semibold">Vidyalankar Anouncement System</h1>
                    </div>
